<template>
  <div>
    ...
    <div class="inline-flex flex-wrap">
      <img class="flex-1 object-cover h-64 m-2 shadow rounded max-w-md transition-all duration-700" v-for="(src,index) in images" :key="index" @click="setIndex(index)" v-lazy="src" alt />
    </div>
  </div>
</template>
